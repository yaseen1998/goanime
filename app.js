  ...
  if (name == 1) {
    ...
    for (ep; ep <= 37; ep++) {
      ...
      document.write("<h4>" + "<a href=" + "https://gogoanime.pe/death-note-episode-" + ep + "> death note Episode " + ep
        + "</a>" + "</h4>"+"<img" + " src=" + "https://static3.srcdn.com/wordpress/wp-content/uploads/2021/03/Death-Note-Characters-Ranked-by-Likability-Feature-Image-2.jpg?q=50&fit=crop&w=960&h=500&dpr=1.5" + " style='height:250px ;width:250px ;'>")
    }break;
  }
  else if (name == 2) {
    var ep = prompt("which episode do you want " + "\n" + "from (1_25)")
