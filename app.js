...
if(name == 1 || name == 2 || name == 3 || name == 4 || name == 5) {
  ...
  if (name == 1) {
    ...
    var ep = prompt("which episode do you want " + "\n" + "from (1_64)")
    document.write("<h3>your favanime :Fullmetal Alchemist (score rate 9.17)</h3> " + "\n" + "<img" + " src=" + "https://thefandomentals.com/wp-content/uploads/2018/11/Webp.net-resizeimage.jpg" + "style='height:750px ;width:750px ;'>")
    for (ep; ep <= 64; ep++) {
      if (ep == 64) {
        ep = "64 the end"
      }
