  ...
  if (name == 1) {
    ...
    for (ep; ep <= 37; ep++) {
      ...
      document.write("<h4>" + "<a href=" + "https://gogoanime.pe/death-note-episode-" + ep + "> death note Episode " + ep
        + "</a>" + "</h4>" + "<img" + " src=" + "https://static3.srcdn.com/wordpress/wp-content/uploads/2021/03/Death-Note-Characters-Ranked-by-Likability-Feature-Image-2.jpg?q=50&fit=crop&w=960&h=500&dpr=1.5 style='width:250px;height:250px;'>")
    }break;
  }
  else if (name == 2) {
    var ep = prompt("which episode do you want " + "\n" + "from (1_25)")
    ...
    for (ep; ep <= 25; ep++) {
      ...
      document.write("<h4>" + "<a href=" + "https://gogoanime.pe/shingeki-no-kyojin-episode-" + ep + ">Attack on titan Episode " + ep
        + "</a>" + "</h4>"+"<img" + " src=" + "https://pbs.twimg.com/profile_images/1324093768618909697/Ij-CAeyd_400x400.jpg style='width:250px;height:250px;'>")
    }break;
    ...
    for (ep; ep <= 64; ep++) {
      ...
      document.write("<h4>" + "<a href=" + "https://gogoanime.pe/fullmetal-alchemist-brotherhood-episode-" + ep + "> Fullmetal Alchemist Episode " + ep
        + "</a>" + "</h4>"+ "<img" + " src=" + "https://thefandomentals.com/wp-content/uploads/2018/11/Webp.net-resizeimage.jpg style='width:250px;height:250px;'>")
    }break;
  }
  else if (name == 4) {
    var ep = prompt("which episode do you want " + "\n" + "from (1_25)")
    ...
    for (ep; ep <= 25; ep++) {
      ...
      document.write("<h4>" + "<a href=" + "https://gogoanime.pe/sword-art-online-episode-" + ep + "> Sword Art Online Episode " + ep
        + "</a>" + "<h4>"+"<img" + " src=" + "https://i.pinimg.com/originals/a6/d9/6b/a6d96b1e585781865bc6b4fe8d97a50f.jpg" + " style='height:250px ;width:250px ;'>")
    ...
    var ep = prompt("which episode do you want " + "\n" + "from (1_12)")
    document.write("<h3>One punch man (score rate 8.54)</h3>")
    for (ep; ep <= 12; ep++) {
      if (ep == 12) {
        ep = "12 the end"
      }
      document.write("<h4>" + "<a href=" + "https://gogoanime.pe/one-punch-man-episode-" + ep + "> One punch man Episode " + ep
        + "</a>" + "<h4>"+ "<img" + " src=" + "https://static.posters.cz/image/1300/poster/one-punch-man-saitama-genos-i87465.jpg" + " style='height:250px ;width:250px ;'>")
